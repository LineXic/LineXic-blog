...
![Trace返回结果.webp](https://img.linexic.top/file/1756573032727_Trace结果.webp)

他帮我推测出以下几个显示以上图片结果可能的原因
1. 运营商故意拦截了
2. 路由器配置问题，建议检查一下路由表

> 可能是防火墙原因，我这边抓包了一下 udp 数据报文已经路由到你那了，但是你那边没有进行响应

我照着他说关掉了路由器的防火墙且重启了网关，我试着在本地Ping 返回如下结果

![ping ip.webp](https://img.linexic.top/file/1756573557115_ping_ip.webp)
